  ...
  return (
    <section ref={ref} id="testimonials" className="py-24 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: "#F5A623" }}>Testimonials</p>
            ...
            >
              <div>
                <span
                  ...
                  style={{
                    backgroundColor: t.featured ? "rgba(245,166,35,0.18)" : "#FEF6E7",
                    color: t.featured ? "#F5C060" : "#F5A623",
                  }}
                >
                  {t.type}
                </span>
