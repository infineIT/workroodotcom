        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <motion.p
              ...
              className="text-sm font-semibold text-indigo-500 uppercase tracking-widest mb-4"
            >
              Get Started
            </motion.p>
            <motion.h2
              ...
              {included.map((item, i) => (
                <li key={i} className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "#EEF2FF" }}>
                    <Check className="w-3 h-3" style={{ color: "#6366F1" }} strokeWidth={3} />
                  </div>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <span className="font-bold text-sm tracking-widest text-indigo-500">INNOVHUB</span>
            </div>
          </div>
          ...
          >
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-10 text-center">
                <div className="w-14 h-14 rounded-full flex items-center justify-center mb-5" style={{ backgroundColor: "#EEF2FF" }}>
                  <Check className="w-7 h-7" style={{ color: "#6366F1" }} strokeWidth={2.5} />
                </div>
